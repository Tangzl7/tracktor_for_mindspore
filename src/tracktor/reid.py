...
if __name__ == '__main__':
    resnet_ = ResNet50_FC512()
    load_checkpoint('../../output/tracktor/MOT17/reid/reid.ckpt', resnet_, strict_load=True)
    img = Tensor(np.ones([1, 3, 300, 300]), ms.float32)
    out = resnet_._forward_impl(img)
    print(out.shape)
    print(out)
